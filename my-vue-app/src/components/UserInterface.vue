      ...
      <div class="content">
        <div class="container-fluid">
          <div class="header-container">
            <h1 style="font-size: 8em;">AutoReportX</h1> 
            <div class="auth-options">
              <div class="auth-links">
                <router-link  :to="'/login'">{{ currentTranslations.login }}</router-link> |
                <router-link to="/signup">{{ currentTranslations.register }}</router-link>
